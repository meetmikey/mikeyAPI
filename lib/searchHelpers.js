...
exports.doSearch = function (query, userId, from, size, searchCallback) {
  ...
  esConnect.client.search(conf.elasticSearch.indexAlias, 'resource', 
    ...
    .on('data', function(data) {
      ...
      esConnect.client.search(conf.elasticSearch.indexAlias, 'resourceMeta', 
        searchHelpers.getChildSearchQuery2 (filteredQuery, userId, size*5, allResources))
          .on('data', function (data) {
