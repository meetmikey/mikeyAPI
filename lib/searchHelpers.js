...
exports.doAttachmentSearch = function (filteredQuery, userId, from, size, callback) {
  console.log ('doAttachmentSearch');
...
exports.getMustClauses = function (userId, filters, isLink) {
...
exports.getSearchQuery = function (filteredQuery, isLink, userId, from, size) {
  //console.log ('getSearchQuery', filteredQuery, isLink, userId);
  var query = searchHelpers.cleanQueryString (filteredQuery.query);

  var must = searchHelpers.getMustClauses (userId, filteredQuery.filters, isLink);
