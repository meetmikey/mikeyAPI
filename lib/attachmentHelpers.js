...
exports.addSignedURLs = function( attachments ) {
  attachments.forEach( function( attachment ) {
    attachment.image = attachmentUtils.getSignedImageURL( attachment, mikeyAPIConstants.IMAGE_EXPIRE_TIME_MINUTES );
  });
}
...
exports.getFilesByCriteria = function( user, before, after, limit, getImages, isFavorite, callback ) {
  ...
  if ( ! user.isPremium ) {
    ...
    if ( ! daysLimit ) {
      ...
      var cutoffDate = new Date(currentTime - daysLimit*scConstants.ONE_DAY_IN_MS);
